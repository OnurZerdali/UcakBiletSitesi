<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UcusEkle.aspx.cs" Inherits="UcusEkle" %>
...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <div class="content-links responsive" style="background-color: #2B2A30">
            <h1 style="color: white">ŞEHİRLER</h1>
        </div>
        <div class="" style="background-color: #fff">
        ...
        <div class="content-links responsive" style="background-color: #2B2A30">
            <h1 style="color: white">UÇUŞ EKLE</h1>
            <asp:Label ID="Label4" runat="server" style="color:white" Text="(Uçak numarası ve şehir numaralarını yukarıdaki tablolardan seçiniz)"></asp:Label>
        </div>
        <div class="container" style="margin-left: 45rem;">
            <div class="row">
                ...
                &nbsp;<br />
                <div class="konteynir">
                    <asp:Label ID="Label8" Font-Size="20pt" ForeColor="#999999" runat="server" Text="Nereden:&nbsp;&nbsp;&emsp;&emsp;&emsp;"></asp:Label><asp:TextBox ID="txtNereden" runat="server"></asp:TextBox>
                </div>
                &nbsp;<br />
                <div class="konteynir">
                    <asp:Label ID="Label1" Font-Size="20pt" ForeColor="#999999" runat="server" Text="Nereye: &emsp;&emsp;&emsp;&emsp;"></asp:Label><asp:TextBox ID="txtNereye" runat="server"></asp:TextBox>
                </div>
                &nbsp;<br />
                <div class="konteynir">
                ...
                &nbsp;<br />
                <div class="konteynir">
                    <asp:Label ID="Label5" Font-Size="20pt" ForeColor="#999999" runat="server" Text="Uçuş fiyatı:&nbsp;&nbsp;&nbsp;&nbsp;&emsp;&emsp;"></asp:Label><asp:TextBox ID="txtFiyat" runat="server"></asp:TextBox>
                </div>
                &nbsp;<br />
