<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Ucuslar.aspx.cs" Inherits="Ucuslar" %>
...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <div class="content-links responsive" style="background-color: #2B2A30">
            <h1 style="color:white">UÇUŞ LİSTESİ</h1>
        </div>
        &nbsp;<br />
        ...
        <div>
            <h1>
                <asp:Label ID="Label1" style="margin-left:40rem; color:white;" runat="server" Text="Uçuş numarası giriniz :&nbsp;"></asp:Label><asp:TextBox ID="txtUcusNo" runat="server" Width="90px"></asp:TextBox>
            </h1>
        </div>
        <div style="margin-left:25rem;">
            <h1>
                <asp:Button ID="ucussil" runat="server" Text="Uçuşu sil" OnClick="ucussil_Click" />
                <asp:Button ID="ucusguncelle" runat="server" Text="Uçuşu güncelle" OnClick="ucusguncelle_Click" />
                <asp:Button ID="ucusekle" runat="server" Text="Uçuş ekle" OnClick="ucusekle_Click" />
                <asp:Button ID="ucusdetay" runat="server" Text="Detay getir" OnClick="ucusdetay_Click" />
            </h1>
        </div>
        <div class="content-links responsive">
            <h2>
