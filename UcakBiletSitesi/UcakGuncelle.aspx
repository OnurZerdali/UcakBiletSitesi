<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UcakGuncelle.aspx.cs" Inherits="UcakGuncelle" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="container" style="margin-left:45rem;">
            <div class="row">
                &nbsp;<br />
                <div class="konteynir">
                    <asp:Label ID="Label4" Font-Size="20pt" ForeColor="#999999" runat="server" Text="Uçak numarası: &nbsp;"></asp:Label><asp:Label ID="lblucakNo" Font-Size="20pt" ForeColor="#999999" runat="server"></asp:Label>
                </div>
                &nbsp;<br />
                <div class="konteynir">
                    <asp:Label ID="Label7" Font-Size="20pt" ForeColor="#999999" runat="server" Text="Uçak kapasitesi:&nbsp;"></asp:Label><asp:Label ID="lblucakkapasite" Font-Size="20pt" ForeColor="#999999" runat="server"></asp:Label>
                </div>
                &nbsp;<br />
                <div class="konteynir">
                    <asp:Label ID="Label9" Font-Size="20pt" ForeColor="#999999" runat="server" Text="Uçak Hakkında: &nbsp;"></asp:Label><asp:TextBox ID="txtHakkinda" runat="server"></asp:TextBox>
                </div>
                &nbsp;<br />
