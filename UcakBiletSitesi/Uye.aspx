...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <div class="content-links responsive" style="background-color: #2B2A30">
            <h1 style="color:white">MÜŞTERİ LİSTESİ</h1>
        </div>
        &nbsp;<br />
        ...
        <div>
            <h1>
                <asp:Label ID="Label1" style="margin-left:40rem; color:white;" runat="server" Text="Müşteri numarası giriniz :&nbsp;"></asp:Label><asp:TextBox ID="txtmusteriNo" runat="server" Width="90px"></asp:TextBox>
            </h1>
        </div>
        <div class="content-links responsive">
            <h1>
                <asp:Button ID="musterisil" runat="server" Text="Müşteriyi sil" OnClick="musterisil_Click" />
                <asp:Button ID="musteriduzenle" runat="server" Text="Müşteriyi düzenle" OnClick="musteriduzenle_Click" />
                <asp:Button ID="musteriekle" runat="server" Text="Müşteri ekle" OnClick="musteriekle_Click" />
            </h1>
        </div>
        <div class="content-links responsive">
            <h2>
